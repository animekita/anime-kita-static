...
function datePicker(options) {
        ...
        o.stopTimer = function stopTimer() {
                o.timerSet = false;
                window.clearTimeout(o.timer);
        };
        o.removeHighlight = function removeHighlight() {
        ...
        o.setOpacity = function setOpacity(op) {
                o.div.style.opacity = op/100;
                o.div.style.filter = 'alpha(opacity=' + op + ')';
                o.opacity = op;
        };
        o.fade = function fade() {
        ...
        o.killEvent = function killEvent(e) {
        ...
        o.getElem = function getElem() {
                return document.getElementById(o.id.replace(/^fd-/, '')) || false;
        };
        o.setRangeLow = function setRangeLow(range) {
                if(String(range).search(/^(\d\d?\d\d)(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])$/) == -1) range = '';
                o.low = o.defaults.low = range;
                if(o.staticPos) o.updateTable(true);
        };
        o.setRangeHigh = function setRangeHigh(range) {
                if(String(range).search(/^(\d\d?\d\d)(0[1-9]|1[012])(0[1-9]|[12][0-9]|3[01])$/) == -1) range = '';
                o.high = o.defaults.high = range;
                if(o.staticPos) o.updateTable(true);
        };
        o.setDisabledDays = function setDisabledDays(dayArray) {
                o.disableDays = o.defaults.disableDays = dayArray;
                if(o.staticPos) o.updateTable(true);
        };
        o.setDisabledDates = function setDisabledDates(dateArray) {
                var fin = [];
        ...
        o.setEnabledDates = function setEnabledDates(dateArray) {
                var fin = [];
                for(var i = dateArray.length; i-- ;) {
        ...
        o.getDisabledDates = function getDisabledDates(y, m) {
        ...
        o.getEnabledDates = function getEnabledDates(y, m) {
                var obj = {};
                var d = datePicker.getDaysPerMonth(m - 1, y);
                m = m < 10 ? "0" + String(m) : m;
        ...
        o.setFirstDayOfWeek = function setFirstDayOfWeek(e) {
                if ( e == null ) e = document.parentWindow.event;
        ...
        o.truePosition = function truePosition(element) {
        ...
        o.realOffset = function realOffset(element) {
                var t = 0, l = 0;
                do {
        ...
        o.cumulativeOffset = function cumulativeOffset(element) {
                var t = 0, l = 0;
                do {
        ...
        o.equaliseDates = function equaliseDates() {
        ...
        o.outOfRange = function outOfRange(tmpDate) {
        ...
        o.changeHandler = function changeHandler() {
                o.setDateFromInput();
                o.updateTable();
        };
        o.setDateFromInput = function setDateFromInput() {
                function m2c(val) {
        ...
        o.returnFormattedDate = function returnFormattedDate() {
        ...
        o.disableTodayButton = function disableTodayButton() {
                var today = new Date();
        ...
        o.updateTableHeaders = function updateTableHeaders() {
                var d, but;
                var ths = o.ths;
                for ( var y = 0; y < 7; y++ ) {
        ...
        o.updateTable = function updateTable(noCallback) {
        ...
        o.addKeyboardEvents = function addKeyboardEvents() {
        ...
        o.removeKeyboardEvents =function removeKeyboardEvents() {
                datePickerController.removeEvent(document, "keypress", o.events.onkeydown);
...
datePickerController = function() {
        ...
        var dateFormat = function dateFormat(dateIn, favourMDY) {
                var dateTest = [
        ...
        var addDatePicker = function addDatePicker(inpId, options) {
                if(!(inpId in datePickers)) datePickers[inpId] = new datePicker(options);
        };
        var getDatePicker = function getDatePicker(inpId) {
